...
/**
 * A list fragment representing a list of Cursos. This fragment also supports
...
//		adaptadorCurso=new ArrayAdapter<Curso>(getActivity(),
//				android.R.layout.simple_list_item_activated_1,
//				android.R.id.text1);
//		
//		setListAdapter(adaptadorCurso);
//		
//		try {
...
//		ContextoAplicacion.Contexto.cursoSet.setAdapter(adaptadorCurso);
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected((Curso)ContextoAplicacion.Contexto.cursoSet.get(position));
